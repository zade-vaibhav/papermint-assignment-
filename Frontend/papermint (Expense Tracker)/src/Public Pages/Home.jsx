...
function Home() {
    ...
    const fetchExpenses = async () => {
        ...
        try {
            const response = await fetch('https://papermint-assignment.onrender.com/api/v1/user/expance/entries', {
                headers: {
                    Authorization: token,
                },
            });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await fetch(`https://papermint-assignment.onrender.com/api/v1/user/expance/${id}`, {
                method: 'DELETE',
                headers: {
